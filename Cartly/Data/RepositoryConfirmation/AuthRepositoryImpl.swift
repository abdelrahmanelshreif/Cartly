...
class AuthRepositoryImpl: AuthRepositoryProtocol {
    ...
    init(
        firebaseAuthClient: FirebaseServiceProtocol,
        shopifyAuthClient: ShopifyServicesProtocol,
        userSessionServices: UserSessionServiceProtocol
    ) {
        self.firebaseAuthClient = firebaseAuthClient
        self.shopifyAuthClient = shopifyAuthClient
        self.userSessionServices = userSessionServices
    }
